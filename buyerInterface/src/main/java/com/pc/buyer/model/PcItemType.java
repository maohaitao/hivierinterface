...
/*  */
@pbdb_alias("pc_item_type")
public class PcItemType {
	@pbdb_ignore
	@Expose
	private Integer id;//remark:商铺ID;length:10; not null,default:null
	@Expose
	private Integer typeid;//remark:对应的ID;length:10; not null,default:0
	@Expose
	private Integer itemid;//remark:对应的item的id;length:10
	@pbdb_alias("i_status")
	@Expose
